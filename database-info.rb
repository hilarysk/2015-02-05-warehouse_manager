...
p3 = Product.new({"serial_num"=>78437, "description"=>"Um, it's a board game based on D&D. And you can go on a quest to DOMESTICATE OWLBEARS. Enough said.", "quantity"=>32, "name"=>"Lords of Waterdeep", "cost"=>3499, "location_id"=>2, "category_id"=>1})
...
p6 = Product.new({"serial_num"=>18779, "description"=>"This is supposedly a child's game, but especially if you play when you're really stoned, it's still pretty fun.", "quantity"=>11, "name"=>"The aMAZEing Labyrinth", "cost"=>1199, "location_id"=>1, "category_id"=>1})
p7 = Product.new({"serial_num"=>72632, "description"=>"It's a mix of luck and strategy, but if both go your way, you can obliterate everyone in one fell swoop. Plus your avatars are bad-ass monsters.", "quantity"=>142, "name"=>"King of Tokyo", "cost"=>2799, "location_id"=>1, "category_id"=>1})
p8 = Product.new({"serial_num"=>875, "description"=>"Yeah, yeah, we know, you're so over this game. But it's the hexagon that launched a thousand knock-offs, so let's give credit where credit is due.", "quantity"=>76, "name"=>"Settlers of Catan", "cost"=>1849, "location_id"=>1, "category_id"=>1})
...
p13 = Product.new({"serial_num"=>47003, "description"=>"Don't swallow these.", "quantity"=>54, "name"=>"Polly Pockets", "cost"=>1000, "location_id"=>3, "category_id"=>2})
...
p15 = Product.new({"serial_num"=>85076, "description"=>"Gotta catch them all!", "quantity"=>8573, "name"=>"Pokemon Cards", "cost"=>500, "location_id"=>3, "category_id"=>2})

p16 = Product.new({"serial_num"=>96422, "description"=>"Don't eat it.", "quantity"=>2817, "name"=>"Gak", "cost"=>500, "location_id"=>3, "category_id"=>2})